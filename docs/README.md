...
- `docs/DOCUMENTATION_STATUS.md`: status-labeled claim map for consequential documentation statements.
- `docs/phase2_zo_mcp_plan.md`: detailed implementation plan for Zo MCP proxy governance path.
- `docs/adversarial_review_phase1_phase2.md`: adversarial findings and mitigations for Phase 1 and Phase 2.
- `docs/phase3_zo_fallback_setup.md`: implementation-ready setup for Zo SSH fallback controls.
- `docs/phase4_zo_production_hardening_plan.md`: phase 4 hardening scope and acceptance criteria.
- `docs/adversarial_review_phase4_iterations.md`: iterative phase 4 adversarial review with pass-state evidence.
- `docs/phase4_substantiation.md`: implementation evidence and validation results for phase 4 hardening.
- `docs/phase5_zo_http_api_release_plan.md`: phase 5 Zo HTTP governance and release-assurance plan.
- `docs/adversarial_review_phase5_iterations.md`: iterative adversarial review for phase 5.
- `docs/phase5_substantiation.md`: implementation evidence and validation results for phase 5.
- `docs/phase6_cross_surface_conformance_plan.md`: cross-surface governance conformance and assumption gate plan.
- `docs/phase7_operational_resilience_plan.md`: operational resilience and release-gate automation plan.
- `docs/phase8_release_substantiation_plan.md`: release substantiation and audit bundle plan.
...
Zo-native design is `implemented` for repository-local scope.
